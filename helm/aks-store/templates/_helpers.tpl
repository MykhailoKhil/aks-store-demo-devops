...
helm.sh/chart: {{ include "aks-store.chart" . }}
{{ include "aks-store.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "aks-store.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "aks-store.fullname" .) .Values.serviceAccount.name }}
{{- else }}
